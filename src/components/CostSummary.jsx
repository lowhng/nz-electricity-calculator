      ...
      appliances[category]?.forEach((appliance, index) => {
        ...
        if (usage > 0) {
          ...
          if (appliance.power) {
            ...
            // Reverse engineer kWh: cost = kWh * electricityRate, so kWh = cost / electricityRate
            const kWhPerUnit = baseCost / electricityRate;
            const totalKWh = kWhPerUnit * usage;
